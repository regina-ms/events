...
;// CONCATENATED MODULE: ./src/js/classBoard.js
...
var Board = /*#__PURE__*/function () {
  function Board(sideSize, element) {
  ...
  _createClass(Board, [{
    ...
    value: function createCells() {
      for (var i = 0; i < Math.pow(this.sideSize, 2); i += 1) {
...
;// CONCATENATED MODULE: ./src/js/classGame.js
function classGame_typeof(o) { "@babel/helpers - typeof"; return classGame_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, classGame_typeof(o); }
...
function classGame_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function classGame_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, classGame_toPropertyKey(descriptor.key), descriptor); } }
function classGame_createClass(Constructor, protoProps, staticProps) { if (protoProps) classGame_defineProperties(Constructor.prototype, protoProps); if (staticProps) classGame_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function classGame_toPropertyKey(t) { var i = classGame_toPrimitive(t, "string"); return "symbol" == classGame_typeof(i) ? i : String(i); }
function classGame_toPrimitive(t, r) { if ("object" != classGame_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != classGame_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var Game = /*#__PURE__*/function () {
  function Game(board, points) {
    classGame_classCallCheck(this, Game);
    this.board = board;
    this.points = points;
  ...
  classGame_createClass(Game, [{
    ...
    key: "getRndCell",
    value: function getRndCell() {
      var rndIndex = Math.floor(Math.random() * this.board.cells.length);
      var rndCell = this.board.cells[rndIndex];
      return rndCell;
    }
  }, {
    key: "createGoblin",
...
;// CONCATENATED MODULE: ./src/js/classPoints.js
...
function classPoints_typeof(o) { "@babel/helpers - typeof"; return classPoints_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, classPoints_typeof(o); }
function classPoints_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function classPoints_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, classPoints_toPropertyKey(descriptor.key), descriptor); } }
function classPoints_createClass(Constructor, protoProps, staticProps) { if (protoProps) classPoints_defineProperties(Constructor.prototype, protoProps); if (staticProps) classPoints_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function classPoints_toPropertyKey(t) { var i = classPoints_toPrimitive(t, "string"); return "symbol" == classPoints_typeof(i) ? i : String(i); }
function classPoints_toPrimitive(t, r) { if ("object" != classPoints_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != classPoints_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var Points = /*#__PURE__*/function () {
  function Points(element) {
    classPoints_classCallCheck(this, Points);
    this.point = 0;
    this.element = element;
  ...
  classPoints_createClass(Points, [{
    key: "addPoint",
    ...
    key: "render",
    value: function render() {
      this.points.innerHTML = "Points: ".concat(this.point);
    }
  }]);
  return Points;
}();
...
var board = new Board(4, root);
board.render();
var points = new Points(root);
points.render();
var game = new Game(board, points);
game.start();
})();
